...
print(a)
print(d)
# The difference is c.reshape(2,3,5)
...
# Yes, because multiplicator is 1.
...
"""
f1 = np.where((d > d_min) & (d < d_mean), 'B', np.where((d > d_mean) & (d < d_max), 'D', np.where(d == d_mean, 'C', np.where(d == d_min, 'A', np.where(d == d_max, 'E', None)))))
print(f1)